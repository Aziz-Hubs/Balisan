...
export function MobileStickyFooter({ product, heroRef }: MobileStickyFooterProps) {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            // Show footer when the Add to Cart button in hero section is scrolled out of view
            // We check if the bottom of the hero section is above the viewport
            const shouldShow = heroRect.bottom < 100
